  ...
  return (
    <main className="forgot_pass_container" id="forgotPassword">
      <div className="forgot_pass_form-wrapper">
        ...
        <p className="forgot_pass_subtext">
          Enter your details below and get back on track!
        </p>
        <label className="forgot_pass_field_email" htmlFor="email">
          Your email
        </label>
        <input
          className="forgot_pass_field_email"
          type="email"
          id="email"
          name="email"
        ...
        <div>
          <Link to="/Login" className="forgot_pass-link_login">
            {" "}
